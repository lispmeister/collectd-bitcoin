...
def new_proxy():
    ...
    node. This is necessary because the Python plugin for collectd is heavily
    multithreaded and each of the defined entrypoints can be called con-
    currently and needs its own proxy.
    """
